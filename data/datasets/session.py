...
class SessionParser:
    def parse(self, raw_session: str) -> Dict[str, List[Any]]:
        raise NotImplementedError()


class ItemSessionParser(SessionParser):

    def __init__(self, indexed_headers: Dict[str, int], item_header_name: str, delimiter: str = "\t"):
        super().__init__()
    ...
    def _get_item(self, entry: List[str]) -> int:
