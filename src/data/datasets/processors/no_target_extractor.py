...
from data.datasets import TARGET_SUFFIX
from data.datasets.processors.processor import Processor
from asme.tokenization.tokenizer import Tokenizer
from data.datasets.processors.utils import get_tokenizer

class NoTargetExtractorProcessor(Processor):

    """
    This processor use the last item in the sequence as a dummy target
