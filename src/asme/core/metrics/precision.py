...
from asme.core.metrics.common import calc_precision
...
class PrecisionMetric(RankingMetric):
    ...
    def __init__(self,
        ...
        super().__init__(metric_id='precision',
    ...
    def _calc_metric(self,
        ...
        return calc_precision(predictions, positive_item_mask, self._k, metric_mask)
