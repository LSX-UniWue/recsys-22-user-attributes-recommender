...
import torch
from asme.models.common.layers.data.sequence import ModifiedSequenceRepresentation, SequenceRepresentation
from asme.models.common.layers.layers import ProjectionLayer, SequenceRepresentationLayer
