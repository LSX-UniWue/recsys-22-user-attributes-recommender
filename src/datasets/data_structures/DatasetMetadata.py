...
class DatasetMetadata:
    def __init__(self, data_file_path: Path, session_key: Optional[List[str]],
                 item_header_name: Union[int, str], delimiter: str, session_index_path: Optional[Path] = None,
                 custom_tokens: Optional[List[str]] = None,
                 stats_columns: Optional[List[Union[str, int]]] = None):
        """
        :param data_file_path: Input file for the dataset in a delimiter separated file
        ...
        :param custom_tokens: custom tokens that are to be included in the vocabulary
        ...
        self.file_prefix: str = data_file_path.stem
        ...
        if custom_tokens is None:
            ...
            self.custom_tokens: List[str] = custom_tokens
