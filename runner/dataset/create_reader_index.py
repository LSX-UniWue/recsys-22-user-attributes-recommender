...
@app.command()
def run(input_path: Path = typer.Argument(..., exists=True, help="file with sessions"),
        output_path: Path = typer.Argument(..., help='index file'),
        session_key: List[str] = typer.Argument(..., help='the names of the columns that comprise the session key'),
