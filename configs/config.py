...
class ModelConfig(object):
    ...
    def add_model_specific_args(cls, parent_parser: ArgumentParser) -> ArgumentParser:
        ...
        parser.add_argument('--{}'.format(cls.MODEL_CONFIG_ITEM_VOC_SIZE), type=int, default=None,
                            help='the item voc size')
        parser.add_argument('--{}'.format(cls.MODEL_CONFIG_MAX_SEQ_LENGTH), type=int, default=None,
